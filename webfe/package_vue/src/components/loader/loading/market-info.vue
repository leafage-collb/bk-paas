<template>
  <content-loader
    ...
    <rect x="121" y="193" rx="2" ry="2" width="200" height="32" />
    ...
    <rect x="121" y="583" rx="2" ry="2" width="200" height="32" />
    <rect x="121" y="670" rx="2" ry="2" width="410" height="32" />
    <rect x="121" y="627" rx="1" ry="1" width="410" height="16" />
    <rect x="121" y="732" rx="2" ry="2" width="69" height="32" />
    <rect x="331" y="583" rx="2" ry="2" width="200" height="32" />
    <rect x="121" y="411" rx="2" ry="2" width="740" height="90" />
    <rect x="325" y="193" rx="2" ry="2" width="200" height="32" />
    <rect x="195" y="97" rx="1" ry="1" width="330" height="16" />
    ...
    <rect x="195" y="49" rx="2" ry="2" width="100" height="32" />
    <rect x="0" y="0" rx="1" ry="1" width="58" height="20" />
    <rect x="0" y="540" rx="1" ry="1" width="58" height="20" />
    <rect x="121" y="44" rx="6" ry="6" width="64" height="64" />
  </content-loader>
</template>
<script>
