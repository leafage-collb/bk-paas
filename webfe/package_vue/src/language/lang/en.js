...
export default {
  ...
  配置不当: 'Misconfigured',
  '您有 {n} 条慢查询告警记录，请尽快处理，以确保应用正常运行。慢查询持续堆积会影响查询效率，严重时会导致应用无法访问。': 'You have {n} slow query alert records. Please address them promptly to ensure the app runs normally. Continuous accumulation of slow queries can affect query efficiency and, in severe cases, make the app inaccessible.',
  '您当前有 <i>{n}</i> 个应用，全部没有告警和闲置状态，请继续保持！': 'You currently have <i>{n}</i> apps, all without alerts and idle status. Keep up the good work!',
  最近操作记录: 'Recent Activity Log',
  仅展示我执行的: 'Show Only My Executions',
  '太棒了！': 'Awesome!',
};
