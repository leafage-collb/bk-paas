...
export default {
  ...
  '已开启 IP 限制': '已开启 IP 限制',
  '未开启 IP 限制': '未开启 IP 限制',
  '启用 IP 限制后，仅白名单中的 IP 可访问应用主模块，预发布和生产环境同时生效。': '启用 IP 限制后，仅白名单中的 IP 可访问应用主模块，预发布和生产环境同时生效。',
  '功能开启后，预发布和生产环境的 IP 限制将立即生效，仅限白名单内 IP 可访问，且该限制仅适用于主模块。': '功能开启后，预发布和生产环境的 IP 限制将立即生效，仅限白名单内 IP 可访问，且该限制仅适用于主模块。',
  '功能停用后，主模块的预发布和生产环境的 IP 限制将立即取消，所有 IP 均可访问。': '功能停用后，主模块的预发布和生产环境的 IP 限制将立即取消，所有 IP 均可访问。',
  添加白名单: '添加白名单',
  '批量导入/导出': '批量导入/导出',
  从文件导入: '从文件导入',
  批量导出: '批量导出',
  ...
  '功能开启后，预发布和生产环境的用户限制将立即生效，仅限白名单用户访问，且该限制仅适用于主模块。': '功能开启后，预发布和生产环境的用户限制将立即生效，仅限白名单用户访问，且该限制仅适用于主模块。',
  '功能停用后，主模块的预发布和生产环境的用户限制将立即取消，所有用户均可访问。': '功能停用后，主模块的预发布和生产环境的用户限制将立即取消，所有用户均可访问。',
  确定删除IP: '确定删除IP',
  ...
  已开启用户限制: '已开启用户限制',
  未开启用户限制: '未开启用户限制',
  '启用用户限制后，仅白名单用户可访问应用主模块，预发布和生产环境同时生效。': '启用用户限制后，仅白名单用户可访问应用主模块，预发布和生产环境同时生效。',
  功能说明: '功能说明',
  配置豁免路径: '配置豁免路径',
  是否停用用户限制: '是否停用用户限制',
  是否开启用户限制: '是否开启用户限制',
  ...
  '实例数：': '实例数：',
  无法使用控制台功能: '无法使用控制台功能',
  '实例当前未处于运行状态，无法登录。': '实例当前未处于运行状态，无法登录。',
  '实例尚未创建成功或宿主机异常，暂无法获取日志。': '实例尚未创建成功或宿主机异常，暂无法获取日志。',
  '文档：': '文档：',
  请填写实例数: '请填写实例数',
  请填写大于0的整数: '请填写大于0的整数',
  ...
  忘记密码: '忘记密码',
  '验证码已发送至<b>短信</b>及<b>企业微信</b>（应用提醒 > 消息提醒），请注意查收！': '验证码已发送至<b>短信</b>及<b>企业微信</b>（应用提醒 > 消息提醒），请注意查收！',
  请输入验证码: '请输入验证码',
  重新获取: '重新获取',
  重置密码: '重置密码',
  ...
  重新部署: '重新部署',
  登录调试: '登录调试',
  该部署未开启构建调试: '该部署未开启构建调试',
  构建调试窗口不可用: '构建调试窗口不可用',
  构建环境已被回收: '构建环境已被回收',
  '创建构建调试控制台会话失败，请稍后重试': '创建构建调试控制台会话失败，请稍后重试',
  '暂无解决方案，可前往“标准输出日志”检测是否异常': '暂无解决方案，可前往“标准输出日志”检测是否异常',
  应用部署成功: '应用部署成功',
  ...
  '预发布环境和生产环境的实例都将被删除；该操作不可撤销，请完整输入{type}': '预发布环境和生产环境的实例都将被删除；该操作不可撤销，请完整输入{type}',
  '确认：': '确认：',
  隐藏: '隐藏',
  显示: '显示',
  ...
  '平台为该类应用提供应用引擎、增强服务、云API 权限、应用市场等功能':
    '平台为该类应用提供应用引擎、增强服务、云API 权限、应用市场等功能',
  '应用 ID': '应用 ID',
  '格式不正确，只能包含：3-20 字符的小写字母、数字、连字符(-)，以小写字母开头':
    '格式不正确，只能包含：3-20 字符的小写字母、数字、连字符(-)，以小写字母开头',
  '请输入 3-20 字符的小写字母、数字、连字符(-)，以小写字母开头':
    '请输入 3-20 字符的小写字母、数字、连字符(-)，以小写字母开头',
  '由小写字母组成，长度小于 20 个字符': '由小写字母组成，长度小于 20 个字符',
  '格式不正确，由小写字母组成，长度小于 20 个字符': '格式不正确，由小写字母组成，长度小于 20 个字符',
  '只允许小写字母、数字、连字符(-)和下划线(_)，以字母开头，长度3-20个字符':
    '只允许小写字母、数字、连字符(-)和下划线(_)，以字母开头，长度3-20个字符',
  '应用的唯一标识，创建后不可修改': '应用的唯一标识，创建后不可修改',
  '由汉字、英文字母、数字组成，长度不超过 20 个字符': '由汉字、英文字母、数字组成，长度不超过 20 个字符',
  '由汉字、英文字母、数字、连字符（-）组成，长度不超过 20 个字符': '由汉字、英文字母、数字、连字符（-）组成，长度不超过 20 个字符',
  标准运维插件: '标准运维插件',
  '集成插件开发框架，插件版本管理，插件运行时等模块': '集成插件开发框架，插件版本管理，插件运行时等模块',
  高级选项: '高级选项',
  构建调试: '构建调试',
  '开启后，本次构建结束前会进入调试模式（最长 30 分钟），期间可登录构建环境进行调试': '开启后，本次构建结束前会进入调试模式（最长 30 分钟），期间可登录构建环境进行调试',
  选择集群: '选择集群',
  '应用创建中，请稍候': '应用创建中，请稍候',
  创建应用: '创建应用',
  ...
  蓝鲸体系内平台地址: '蓝鲸体系内平台地址',
  变量: '变量',
  '此处展示的内置变量不包含增强服务所写入的环境变量，更多说明请参考': '此处展示的内置变量不包含增强服务所写入的环境变量，更多说明请参考',
  内置环境变量说明: '内置环境变量说明',
  操作记录: '操作记录',
  发布: '发布',
  '操作记录：暂无': '操作记录：暂无',
  ...
  前端组件库: '前端组件库',
  申请成为开发者: '申请成为开发者',
  '所有进程 {n} limit 的总和': '所有进程 {n} limit 的总和',
  '已启用自动扩缩容，按弹性范围展示': '已启用自动扩缩容，按弹性范围展示',
  '核（预发布）': '核（预发布）',
  '核（生产环境）': '核（生产环境）',
  告警数量: '告警数量',
  '访问数(pv)': '访问数(pv)',
  ...
  'CPU 使用率阈值需为 1-100 的整数': 'CPU 使用率阈值需为 1-100 的整数',
  '请输入 1 - 65535 的整数，非必填': '请输入 1 - 65535 的整数，非必填',
  ...
  '<p>同时满足以下条件的模块才能创建沙箱：</p><p>1. 使用 “蓝鲸 Buildpack” 构建</p><p>2. 开发语言为 Python 或 Go</p><p>3. 已成功部署到预发布环境</p>': '<p>同时满足以下条件的模块才能创建沙箱：</p><p>1. 使用 “蓝鲸 Buildpack” 构建</p><p>2. 开发语言为 Python 或 Go</p><p>3. 已成功部署到预发布环境</p>',
  ...
  工具数: '工具数',
  工具列表: '工具数',
  '请输入 MCP Server 名称或描述': '请输入 MCP Server 名称或描述',
  本地开发: '本地开发',
  仓库类型: '仓库类型',
  已有代码仓库: '已有代码仓库',
  提交代码到代码仓库: '提交代码到代码仓库',
  '新建代码仓库（由平台自动创建）': '新建代码仓库（由平台自动创建）',
  '将自动创建该私有仓库并完成模板代码初始化{t}，当前用户默认为仓库管理员。': '将自动创建该私有仓库并完成模板代码初始化{t}，当前用户默认为仓库管理员。',
  '（默认使用 Dockerfile 构建，创建成功后可修改）': '（默认使用 Dockerfile 构建，创建成功后可修改）',
  '搜索变量名/变量值': '搜索变量名/变量值',
  '搜索变量名/变量值/描述': '搜索变量名/变量值/描述',
  变量名: '变量名',
  变量值: '变量值',
  配置说明: '配置说明',
  '开发者中心目前不支持托管自定义访问地址的 HTTPS 证书，请确保已经在外部网关中配置好证书。': '开发者中心目前不支持托管自定义访问地址的 HTTPS 证书，请确保已经在外部网关中配置好证书。',
  副本数策略: '副本数策略',
  以页面配置为准: '以页面配置为准',
  以应用描述文件为准: '以应用描述文件为准',
  更新应用副本数策略成功: '更新应用副本数策略成功',
  '重新部署时，忽略 S-mart 包中的副本数，保持当前线上副本数不变。': '重新部署时，忽略 S-mart 包中的副本数，保持当前线上副本数不变。',
  '重新部署时，进程副本数恢复为 S-mart 包中定义的数量。如未指定，则使用页面上的副本数。': '重新部署时，进程副本数恢复为 S-mart 包中定义的数量。如未指定，则使用页面上的副本数。',
  暂无收藏的应用: '暂无收藏的应用',
  '将鼠标悬浮到应用，点击收藏图标': '将鼠标悬浮到应用，点击收藏图标',
  '应用密钥是云 API 调用的身份凭证，可访问所有已授权的云 API。': '应用密钥是云 API 调用的身份凭证，可访问所有已授权的云 API。',
  '为确保安全，请妥善保管并定期更换您的密钥，推荐通过环境变量或加密存储进行保存。': '为确保安全，请妥善保管并定期更换您的密钥，推荐通过环境变量或加密存储进行保存。',
  '切勿将密钥暴露在客户端代码、日志文件或版本控制系统中。如发现密钥泄露，请立即在开发者中心更换。': '切勿将密钥暴露在客户端代码、日志文件或版本控制系统中。如发现密钥泄露，请立即在开发者中心更换。',
  'S-mart 打包工具': 'S-mart 打包工具',
  '构建 S-mart 包': '构建 S-mart 包',
  '请输入分支 / 包名': '请输入分支 / 包名',
  打包历史: '打包历史',
  执行详情: '执行详情',
  构建: '构建',
  ...
  多模块应用: '多模块应用',
  单模块应用: '单模块应用',
  'S-mart 应用特性说明': 'S-mart 应用特性说明',
  可在根目录下执行如下命令生成源码包: '可在根目录下执行如下命令生成源码包',
  '支持的文件格式包括：.tgz 和 .tar.gz，并确保 app_desc.yaml 文件在根目录': '支持的文件格式包括：.tgz 和 .tar.gz，并确保 app_desc.yaml 文件在根目录',
  'S-mart 应用包是一种便捷的应用打包与交付方式，每个 S-mart 应用包可以直接部署到其他环境中。本工具支持将源代码打包为 S-mart 应用包。': 'S-mart 应用包是一种便捷的应用打包与交付方式，每个 S-mart 应用包可以直接部署到其他环境中。本工具支持将源代码打包为 S-mart 应用包。',
  切换为代码仓库: '切换为代码仓库',
  是否切换为代码仓库: '是否切换为代码仓库',
  '一旦修改为代码仓库部署后，不能再改回源码包部署。': '一旦修改为代码仓库部署后，不能再改回源码包部署。',
  复制审批链接: '复制审批链接',
  '如需创建 AI 插件，请前往 AIDEV 平台。': '如需创建 AI 插件，请前往 AIDEV 平台。',
  公共采集项: '公共采集项',
  '公共采集项由平台统一接入日志平台，不支持在日志平台进行单独的检索、配置。': '公共采集项由平台统一接入日志平台，不支持在日志平台进行单独的检索、配置。',
  '该 MCP Server 已开启 OAuth2 公开客户端模式。在 Cursor、CodeBuddy 等工具中通过 OAuth 授权使用时，无需在此申请权限，授权完成后即可使用；仅在需要以当前应用的 ID / 密钥调用该 MCP 时，才需申请权限。': '该 MCP Server 已开启 OAuth2 公开客户端模式。在 Cursor、CodeBuddy 等工具中通过 OAuth 授权使用时，无需在此申请权限，授权完成后即可使用；仅在需要以当前应用的 ID / 密钥调用该 MCP 时，才需申请权限。',
  申请成为管理员: '申请成为管理员',
};
