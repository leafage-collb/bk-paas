...
export default {
  ...
  '灰度发布需由<em>工具管理员</em>进行审批；<span>若选择了灰度组织范围，还需要由<em>工具发布者的直属Leader</em>同时进行审批。</span>': '灰度发布需由<em>工具管理员</em>进行审批；<span>若选择了灰度组织范围，还需要由<em>工具发布者的直属Leader</em>同时进行审批。</span>',
  ...
  缺少维护: '缺少维护',
  配置不当: '配置不当',
  '您有 {n} 条慢查询告警记录，请尽快处理，以确保应用正常运行。慢查询持续堆积会影响查询效率，严重时会导致应用无法访问。': '您有 {n} 条慢查询告警记录，请尽快处理，以确保应用正常运行。慢查询持续堆积会影响查询效率，严重时会导致应用无法访问。',
  '您当前有 <i>{n}</i> 个应用，全部没有告警和闲置状态，请继续保持！': '您当前有 <i>{n}</i> 个应用，全部没有告警和闲置状态，请继续保持！',
  最近操作记录: '最近操作记录',
  仅展示我执行的: '仅展示我执行的',
  '太棒了！': '太棒了！',
};
