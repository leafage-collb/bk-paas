...
export default {
  ...
  '沙箱提供云端开发环境，可在线修改运行代码。每个模块仅允许新建一个沙箱环境。': '沙箱提供云端开发环境，可在线修改运行代码。每个模块仅允许新建一个沙箱环境。',
  '沙箱环境仅用于临时在线调试，如果沙箱环境在 6 小时内没有任何操作，将自动被销毁。': '沙箱环境仅用于临时在线调试，如果沙箱环境在 6 小时内没有任何操作，将自动被销毁。',
  '仅使用“蓝鲸 Buildpack”构建且开发语言为 Python，并部署到预发布环境的模块，才能启用沙箱开发功能': '仅使用“蓝鲸 Buildpack”构建且开发语言为 Python，并部署到预发布环境的模块，才能启用沙箱开发功能',
