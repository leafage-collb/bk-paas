  ...
  data() {
    return {
      apiData: {
        ...
        apiexplain: this.$t('蓝鲸API网关服务，帮助开发者创建、发布、维护、监控和保护 API，以快速、低成本、低风险地对外开放蓝鲸应用或其他系统的数据或服务'),
        apiList: [
          {
          ...
          {
            title: this.$t('监控告警'),
            explain: this.$t('提供可视化的 API 实时监控，包括：请求数、失败请求数、平均响应时间、统计响应时间，以便实时掌握 API 运行情况。'),
          },
        ],
      },
    };
